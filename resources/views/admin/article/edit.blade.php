                    ...
                    <div class="row">
                        <form action="{{ url('admin/article/edit/'. $article->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <p><img src="{{asset('public/upload/article/').'/'.$article->thumb }}"></p>
                            ...
                            <div class="form-group">
                                ...
                                @if($article->visibility == 0)
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="visibility" id="inputIs_hightlight" value="0" checked="">
                                            Ẩn
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="visibility" id="inputIs_hightlight" value="1">
                                            Hiện
                                        </label>
                                    </div>
                                @else
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="visibility" id="inputIs_hightlight" value="0">
                                            Ẩn
                                        </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="visibility" id="inputIs_hightlight" value="1" checked="">
                                            Hiện
                                        </label>
                                    </div>
                                @endif
