                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="post_content">
                                        <div class="post_category cat_world"><a href="{{ url('category') }}/{{ $article->cat_slug }}">{{ $article->cat_name }}</a></div>
                                        <div class="post_title"><a href="{{ url('article') }}/{{ $article->slug }}">{{ $article->title }}</a></div>
                                        <div class="post_info d-flex flex-row align-items-center justify-content-start">
                                            <div class="post_author d-flex flex-row align-items-center justify-content-start">
                                                <div><div class="post_author_image"><img src="{{ asset('public/upload/avatar') }}/{{ $article->avatar }}" class="avatar-circle"></div></div>
                                                <div class="post_author_name"><a href="#">{{ $article->user_name }}</a></div>
                                            </div>
